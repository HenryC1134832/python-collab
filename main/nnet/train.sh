...
python /workdir/denoiser/main/nnet/trainnew.py --gpus 0,1 --epochs 50 --checkpoint /workdir/denoiser/MS_SL1_only_attention_saved_models --batch-size 8 --num-workers 0
