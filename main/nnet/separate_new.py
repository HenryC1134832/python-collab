...
#from model import MB_ConvTasNet, MS_SL2_split_model 
# from model import MS_SL2_split_model
# from model_2023_03_28 import MS_SL2_split_model 
# from model_2022_12_21_ch import MS_SL2_split_model
# from model_2022_09_05 import MB_ConvTasNet  #for slice and multislice model
# from model_2022_12_21_ch import MB_ConvTasNet  
# from model_2023_03_28 import MB_ConvTasNet  
# from model_202111129 import MB_ConvTasNet
# from model_ChannelShuffle_Fusion import MS_SL2_split_model #for Fusion model
from model_2024_01_19_Fusion import MS_SL2_split_model #for Fusion model
#from model_max_only_att_aicenter import MS_SL1_only_attention_model
# from model_max_mulit_a_tt_head16 import MS_SL1_mulit_attention_model
...
class NnetComputer(object):
    ...
    def _load_nnet(self, cpt_dir, cpt_epoch):
        ...
        for param in nnet.slices[0][0][0].shuffgroupconv.parameters(): # disable the shuffle group convolution during the testing
