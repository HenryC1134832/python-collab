...
#from model import ConvTasNet, MB_ConvTasNet, MS_SL2_model, MS_SL2_split_model
...
if __name__ == "__main__":
    ...
    parser.add_argument("checkpoint", default="/media/speech70809/Data02/MS_SL1_split_channelWise_models", type=str, help="Directory of checkpoint")
    #parser.add_argument("/media/speech70809/Data02/MS_SL1_split_channelWise_models" type=str, help="Directory of checkpoint")
    parser.add_argument("--cpt_epoch", type=str, default='best', help="epoch of checkpoint")
    parser.add_argument(
        "--input", type=str, default="/media/speech70809/Data01/speech_donoiser_new/datasets/ner-300hr/tt/new_mix.scp", required=True, help="Script for input waveform")
    parser.add_argument(
        "--gpu",
        type=int,
        default=0,
    ...
    parser.add_argument(
        "--dump-dir",
        type=str,
        default="/media/speech70809/Data02/MS_SL1_split_channelWise_models/channelwise_sl1_tt",
